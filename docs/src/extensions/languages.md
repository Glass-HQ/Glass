...
This feature provides two levels of granularity for navigating around files. Section-by-section navigation and method-by-method navigation. Even languages that don't support functions and classes can work well by defining similar concepts. For example CSS defines a rule-set as a method, and a media-query as a class.
